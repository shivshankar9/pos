    ...
    <section className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
      <div className="space-y-8">
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight">
          ...
          <span className="text-purple-500">automated business solutions</span>
          <br />
          <span className="text-slate-900">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-6 text-lg font-medium">
            <span className="text-slate-900">Supercharge Payments</span>
            <span className="text-slate-900">Instantly Deploy Payouts</span>
            <span className="text-slate-900">Seamlessly Manage Operations</span>
            <span className="text-slate-900">
