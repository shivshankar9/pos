    ...
    <div className="bg-gray-100 min-h-screen py-12">
      <div className="bg-white shadow-md rounded-md max-w-3xl mx-auto px-8 py-10 border border-gray-300">
        ...
        <section className="space-y-6">
          ...
          <p className="text-gray-600">
            Finverge Tech provides innovative software solutions, including apps
            like <span className="font-semibold">Opportune</span>, and other
            services to enhance business and individual productivity. Detailed
            descriptions of the services provided will be available on the
            respective service pages on our website.
          </p>
          ...
          <p className="text-gray-600">
            ...
            of our services. In no event shall our liability exceed the amount
            paid for the service that caused the damage.
          </p>
          ...
          <div className="pl-4 border-l-4 border-gray-300">
            ...
            <p className="text-gray-600">
              Customers who request a refund within 24 hours of the transaction
